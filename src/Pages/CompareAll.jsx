...
const CompareAll = () => {
  return (
    <div className="w-full p-4 bg-CustomBlack-3 pb-10 ">
        ...
        <div className="max-w-4xl mx-auto p-6 rounded-lg bg-opacity-10 bg-CustomBlack-2 shadow-md shadow-CustomYellow-1 bg-CustomBlack-2">
          <div className="overflow-x-auto ">
            <table className="w-full text-left text-lg text-CustomYellow-2">
              ...
              <tbody>
                <tr className="border-b border-gray-700 hover:bg-CustomBlack-1 transition duration-200">
                ...
                <tr className="hover:bg-CustomBlack-1 transition duration-200">
                  <td className="py-3 px-4 font-semibold">
                    Other key benefits
                  </td>
                  <td className="py-3 px-4">
