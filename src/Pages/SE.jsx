...
const SE = () => {
  ...
  return (
    <div className="">
      ...
      animate={{ boxShadow: ['0 0 30px rgba(255, 223, 0, 0.4)', '0 0 50px rgba(255, 223, 0, 0.7)', '0 0 30px rgba(255, 223, 0, 0.4)'] }}
      transition={{
        duration: 2,
        repeat: Infinity,
        repeatType: 'mirror',
      ...
      <table className="w-full text-left text-lg text-CustomYellow-2">
        <tbody>
          ...
          <tr className="border-gray-700">
            ...
            <td className="py-2 px-4">2.7Kwh</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Battery features</td>
          ...
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Battery warranty</td>
            <td className="py-2 px-4">3 Years</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Charging time</td>
            <td className="py-2 px-4">4 hours (12A)</td>
          </tr>
          <tr className=" border-gray-700">
          ...
          <tr className=" border-gray-700">
            ...
            <td className="py-2 px-4">55 km/h</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Warranty on electronics</td>
            <td className="py-2 px-4">1 year</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Max range (@30km/h)</td>
            <td className="py-2 px-4">150 km</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Max range (@45km/h)</td>
            <td className="py-2 px-4">110 km</td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Max range (@full speed)</td>
            <td className="py-2 px-4"></td>
          </tr>
          <tr className=" border-gray-700">
            <td className="py-2 px-4 font-semibold">Other key benefits</td>
            <td className="py-2 px-4">
